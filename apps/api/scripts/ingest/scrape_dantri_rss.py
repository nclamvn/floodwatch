...
Fetches disaster/weather news from Dantri RSS feeds and stores as Reports.
Source: Dantri (trust score 0.9)
"""
...
# Dantri RSS feeds for disaster/weather news
RSS_FEEDS = [
    "https://dantri.com.vn/rss/xa-hoi.rss",  # Society - includes disasters
    "https://dantri.com.vn/rss/su-kien.rss",  # Events
]
...
def scrape_dantri_rss(dry_run: bool = False) -> int:
    """
    Scrape Dantri RSS feeds and store as Reports.
    ...
    """
    print(f"[{datetime.now()}] Starting Dantri RSS scraper...")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Scrape Dantri RSS feeds for disaster news")
    parser.add_argument("--dry-run", action="store_true", help="Show what would be inserted without saving")
    args = parser.parse_args()

    count = scrape_dantri_rss(dry_run=args.dry_run)
