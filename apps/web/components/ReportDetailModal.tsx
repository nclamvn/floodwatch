...
export default function ReportDetailModal({ report, isOpen, onClose }: ReportDetailModalProps) {
  ...
  const getTypeColor = (type: string) => {
    switch (type) {
      ...
      case 'RAIN': return 'bg-neutral-500/20 text-neutral-400 border-neutral-500/30'
      case 'NEEDS': return 'bg-neutral-500/20 text-neutral-400 border-neutral-500/30'
        ...
        >
          ...
          <div className="px-6 py-5 border-b border-slate-200/50 dark:border-neutral-700 flex items-start justify-between">
            <div className="flex-1">
              ...
              <h2 className="text-xl font-bold text-gray-900 dark:text-neutral-50 leading-tight">
          ...
          <div className="px-6 py-5 overflow-y-auto max-h-[calc(85vh-180px)] custom-scrollbar">
            ...
            <div className="mb-6">
              ...
              <p className="text-gray-900 dark:text-neutral-50 leading-relaxed whitespace-pre-wrap">
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
              <div>
                ...
                <p className="text-gray-900 dark:text-neutral-50 flex items-center gap-1">
              ...
              {report.lat && report.lon && (
                <div>
                  ...
                  <p className="text-gray-900 dark:text-neutral-50 text-sm font-mono">
            ...
            <div className="mb-6">
              ...
              <div className="flex items-center gap-3">
                <div className="flex-1 h-2 bg-gray-200 dark:bg-neutral-900 rounded-full overflow-hidden">
                  <div
                ...
                <span className="text-gray-900 dark:text-neutral-50 font-semibold tabular-nums">
            ...
            <div>
              ...
              <span className={`inline-flex px-3 py-1.5 rounded-lg text-sm font-medium ${
                ...
                report.status === 'resolved' ? 'bg-neutral-500/20 text-neutral-600 dark:text-neutral-400' :
          ...
          <div className="px-6 py-4 border-t border-slate-200/50 dark:border-neutral-700 flex items-center justify-between bg-gray-50/50 dark:bg-neutral-950/50">
            ...
            {report.source && (report.source.startsWith('http') || report.source.includes('www')) && (
              <a
                ...
                className="inline-flex items-center gap-2 px-4 py-2 bg-neutral-600 hover:bg-neutral-700 active:bg-neutral-800 text-white rounded-lg font-semibold transition-colors text-sm"
              >
                <span>Nguồn tin</span>
