...
import { MapPin, Route, HandHeart, Bell, Navigation, Users, AlertCircle, MapPinned, Heart } from 'lucide-react'
  ...
  return (
    <main className="relative min-h-screen bg-white dark:bg-neutral-950 overflow-hidden">
      ...
      <div className="relative z-10 min-h-screen flex flex-col items-center justify-center px-6 py-32" style={{ marginTop: '-48px' }}>
        <div className="w-full max-w-7xl space-y-28">

          {/* Hero Section - Professional & Serious */}
          <div className="text-center space-y-10">

            {/* Professional Badge */}
            <div className="inline-flex items-center gap-2.5 px-5 py-2.5 rounded-full bg-white/80 dark:bg-neutral-900/80 backdrop-blur-xl border border-slate-200 dark:border-neutral-800 shadow-sm">
              <AlertCircle className="w-4 h-4 text-slate-600 dark:text-neutral-400" strokeWidth={2} />
            ...
            <div className="space-y-6">
              <h1 className="text-7xl sm:text-8xl md:text-9xl font-bold tracking-tight leading-[0.9] text-slate-900 dark:text-white">
                Thông tin<br />mưa lũ
              </h1>
            ...
            <p className="text-xl md:text-2xl text-slate-600 dark:text-neutral-400 max-w-3xl mx-auto leading-relaxed font-light">
