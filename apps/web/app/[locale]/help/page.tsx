...
const RescueMap = dynamic(() => import('@/components/RescueMap'), {
  ssr: false,
  loading: () => <div className="w-full h-dvh flex items-center justify-center">Loading rescue map...</div>
})
          ...
          <div className="lg:hidden">
            ...
            <div className="flex gap-2">
              ...
              >
                ...
                <span className="text-xs">{t('needHelpShort')}</span>
              </button>
              <button
              ...
              >
                ...
                <span className="text-xs">{t('canHelpShort')}</span>
              </button>
              <button
              ...
              >
                ...
                <span className="text-xs">{t('rescueMapShort')}</span>
              </button>
            </div>
          </div>
